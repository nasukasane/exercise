...
import { ChoiceTables, PickSet, Problem, config } from "./main";
...
export default function Options(
  { props: { sectionCount, problemCount, choiceTables, problem, choicedNumber, choicedSet, checkResult, optionIndexes,
    setChoicedNumber, setChoicedSet, setCanSubmit } }:
    {
      props: {
        sectionCount: number,
        problemCount: number,
  ...
  return (
    <div>
      {checkResult === 'N' ?
        <ToBeSolved props={{ problem, options, optionIndexes, choicedSet, choicedNumber, handleClick }}/>
        : 
        <AfterSolved props={{ sectionCount, problemCount, problem, optionIndexes, choiceTables}} />
      }
    </div>
  );
}