...
export function GlobalNav() {
  ...
  return (
    <div className="fixed top-0 z-10 flex w-full flex-col border-b border-gray-800 bg-white md:bottom-0 md:z-auto md:w-72 md:border-b-0 md:border-r md:border-gray-800">
